  ...
  return `
    <div class="card"><h2>Mis pronósticos</h2>
      ...
      ${matches.map(m=>{
        ...
        const fieldsLocked = (locked && !isGlobalAdmin()) || (hasSaved && !editing)
