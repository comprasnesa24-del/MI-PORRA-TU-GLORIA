...
Object.assign(window,{login,register,logout,setTab,changePool,setCompetition,selectPool,createPool,joinPool,leavePool,deletePool,savePrediction,saveGlobalReal,resetGlobalReal,updatePoolSettings,editPoolPrizes,saveProfile,toggleAutoCopyPredictions,changePassword,loadAdminUsers,adminResetUserPassword,adminRestoreUser,adminDeleteUser,sendMessage,refreshChat,savePodiumPrediction,saveRealPodium,saveLeagueTablePrediction,refreshLeagueTableSelects,toggleLeagueTableVisibility,editRoundMoneyRules,showPodiumNow,saveMixPrediction,saveMixResults})
