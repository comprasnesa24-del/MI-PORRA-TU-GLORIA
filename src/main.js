...
function podiumReminderHtml(){if(!podiumMissing())return'';return `<div class="podium-modal"><div class="podium-modal-card"><h2>Recuerda el podio</h2><p>Antes del ${podiumDeadlineText()} tienes que elegir:</p><ul><li>Campeón del Mundial</li><li>Segundo del Mundial</li><li>Tercero del Mundial</li></ul><p class="muted">Campeón +20 · Segundo +15 · Tercero +10</p><button class="yellow" onclick="window.setTab('partidos')">Ponerlo ahora</button></div></div>`}
